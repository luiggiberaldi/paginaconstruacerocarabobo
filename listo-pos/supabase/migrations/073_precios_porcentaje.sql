-- 073_precios_porcentaje.sql
-- Agregar columnas para guardar el porcentaje de ganancia
ALTER TABLE public.productos
  ADD COLUMN IF NOT EXISTS precio1_porcentaje NUMERIC,
  ADD COLUMN IF NOT EXISTS precio2_porcentaje NUMERIC,
  ADD COLUMN IF NOT EXISTS precio3_porcentaje NUMERIC;

-- Actualizar la funcion de crear producto
...
-- Actualizar la funcion de actualizar producto
