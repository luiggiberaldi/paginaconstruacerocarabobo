...
BEGIN
  ...
  IF v_es_credito THEN
    ...
    BEGIN
      IF jsonb_typeof(v_despacho.forma_pago) = 'string' THEN
        v_forma_pago_json := (v_despacho.forma_pago#>>'{}')::jsonb;
      ELSE
        v_forma_pago_json := v_despacho.forma_pago;
      END IF;
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      IF jsonb_typeof(r.forma_pago) = 'string' THEN
        v_forma_pago_json := (r.forma_pago#>>'{}')::jsonb;
      ELSE
        v_forma_pago_json := r.forma_pago;
      END IF;
